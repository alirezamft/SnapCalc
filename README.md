...
- رابط کاربری مینیمال با فونت YekanX
...
- **فونت‌ها عجیب‌اند**: اینترنت وصل باشد تا YekanX از CDN لود شود؛ یا فونت را داخل SVG اینلاین کنید (اختیاری).
- **اشتراک‌گذاری X کاراکتر کم دارد**: وب‌اینترنت X برای «Quote» محدود است؛ این افزونه فقط **متن** را باز می‌کند.

---

## پرسش‌های رایج (FAQ)

**۱) آیا افزونه به‌صورت خودکار پست در X می‌سازد؟**  
خیر؛ فقط متن را داخل composer باز می‌کند. شما باید دستی ارسال کنید.

**۲) آیا این افزونه داده‌ای به جایی می‌فرستد؟**  
...
## مشارکت
PR و Issue خوشحال‌مان می‌کند!  
- برای باگ‌ها: مراحل بازتولید + اسکرین‌شات  
- برای فیچرها: توضیح کوتاه و ساده
